...
func main() {
	...
	flag.DurationVar(&cfg.db.maxIdleTime, "db-max-idle-time", 15*time.Minute, "PostgreSQL maximum idle connection time")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "0942431eb9fc02", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "aa93ca3cb86281", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.marshallmahachi.net>", "SMTP sender")
